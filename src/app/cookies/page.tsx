        ...
        <div className="max-w-4xl mx-auto px-6">
          <div className="space-y-12">
            ...
            <div>
              ...
              <p className="text-gray-600 leading-relaxed">
                If you have questions about our use of cookies, please contact us at <a href="mailto:info@medialiftadvisor.com" className="text-[#C9A227] hover:underline">info@medialiftadvisor.com</a>.
              </p>
            </div>
