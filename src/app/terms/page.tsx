        ...
        <div className="max-w-4xl mx-auto px-6">
          <div className="space-y-12">
            ...
            <div>
              ...
              <p className="text-gray-600 leading-relaxed">
                If you have any questions about these Terms of Use, please contact us at <a href="mailto:hello@medialift.com" className="text-[#FFB800] hover:underline">hello@medialift.com</a>.
              </p>
            </div>
