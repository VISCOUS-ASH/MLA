        ...
        <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
          ...
          >
            ...
            <motion.span
              ...
              className="inline-block px-5 py-2 border border-[#C9A227]/40 rounded-full text-[#C9A227] text-xs font-bold tracking-[2px] uppercase mb-6"
            >
            ...
            <h2 className="text-4xl sm:text-5xl md:text-6xl font-black text-white leading-[1.1] tracking-[-2px] mb-6">
              Scale Smarter with{" "}
              <span className="text-[#C9A227]">{founder.name}</span>
            </h2>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
              <motion.a
                ...
                whileTap={{ scale: 0.97 }}
                className="inline-flex items-center justify-center gap-2 px-8 py-4 bg-[#C9A227] opacity-[80%] text-white font-semibold rounded-full hover:bg-[#FF5252] transition-colors"
              >
